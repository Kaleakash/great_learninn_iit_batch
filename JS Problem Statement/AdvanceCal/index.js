...
function addChar(character) {
    if(input.innerText == null || input.innerText == "0")
        ...
        input.innerText += character        // append the character 
}
...
function sqrt() {
    input.innerText = Math.sqrt(input.innerText);       //input.innerText (9)
}
...
function compute() {
    input.innerText = eval(input.innerText)     // convert string to number 
}
...
function checkNum() {
    var str=input.innerText     // str string object consider. 
